 ...
 <div class="container">
     <form action="/salvarProjeto" method="post" name="formProjeto" id="formProjeto"  >
      ...
      <div class="card" style="margin-top: 10px">
         <div class="card-body">
             <h5 class="card-title" style="margin-bottom: 25px;">Alteração de Projeto</h5>
                 ...
                 <div class="row g-3"  style="margin-bottom: 15px;">
                     <div class="col-md-3">
                         ...
                         <input type="text" class="form-control datepicker" name="dataInicio" id="dataInicio" value="${projeto.dataInicio}">
                     </div>
                     <div class="col-md-3">
                         <label for="dataPrevisaoFim" class="form-label">Data previsão término</label>
                         <input type="text" class="form-control" name="dataPrevisaoFim" id="dataPrevisaoFim" value="${projeto.dataPrevisaoFim}">
                     </div>
                     <div class="col-md-3">
                         <label for="dataFim" class="form-label">Data real término</label>
                         <input type="text" class="form-control" name="dataFim" id="dataFim" value="${projeto.dataFim}">
                     </div>
                 </div>
                 ...
                 <div class="row g-3"  style="margin-bottom: 15px;">
                     <div class="col-md-3">
                         ...
                         <input type="text" id="orcamento" name="orcamento" value="${projeto.orcamento}" class="form-control" data-thousands="." data-decimal="," data-prefix="R$ " />
                     </div>
                     <div class="col-md-3">
                         ...
                         <select class="form-select" aria-label="Default select example" id="risco" name="risco">
                             ...
                             <option value="Baixo risco" ${projeto.risco == 'Baixo risco' ? 'selected="selected"' : ''}>Baixo risco</option>
                             <option value="Médio risco" ${projeto.risco == 'Médio risco' ? 'selected="selected"' : ''}>Médio risco</option>
                             <option value="Alto risco" ${projeto.risco == 'Alto risco' ? 'selected="selected"' : ''}>Alto risco</option>
                         </select>
                     </div>
                     ...
                     <div class="col-md-3">
                         ...
                         <select class="form-select" aria-label="Default select example" id="status" name="status">
                             <option value="" selected></option>
                             <option value="Em análise" ${projeto.status == 'Em análise' ? 'selected="selected"' : ''}>Em análise</option>
                             <option value="Análise realizada" ${projeto.status == 'Análise realizada' ? 'selected="selected"' : ''}>Análise realizada</option>
                             <option value="Análise aprovada" ${projeto.status == 'Análise aprovada' ? 'selected="selected"' : ''}>Análise aprovada</option>
                             <option value="Iniciado" ${projeto.status == 'Iniciado' ? 'selected="selected"' : ''}>Iniciado</option>
                             <option value="Planejado" ${projeto.status == 'Planejado' ? 'selected="selected"' : ''}>Planejado</option>
                             <option value="Em andamento" ${projeto.status == 'Em andamento' ? 'selected="selected"' : ''}>Em andamento</option>
                             <option value="Encerrado" ${projeto.status == 'Encerrado' ? 'selected="selected"' : ''}>Encerrado</option>
                             <option value="Cancelado" ${projeto.status == 'Cancelado' ? 'selected="selected"' : ''}>Cancelado</option>
                         </select>
                     </div>
                     ...
                     <div class="col-md-3">
                         ...
                         <select class="form-select" aria-label="Default select example" id="idgerente" name="idgerente">
                             ...
                             <c:forEach items="${gerentes}" var="gerente">
                                 <option value="${gerente.id}" ${projeto.idgerente == gerente.id ? 'selected="selected"' : ''}>${gerente.nome}</option>
                             </c:forEach>
                         </select>
                     </div>
                     <div class="col-md-6">
